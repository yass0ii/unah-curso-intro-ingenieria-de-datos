--
-- @author: Pablo Abad Aparicio
-- @source: https://github.com/pabloabap/Base-de-datos-SQL_Universidad
--

-- CREACIÓN DE LA BASE DE DATOS
	-- Eliminamos base de datos 'Facultad' si existe
DROP DATABASE IF EXISTS IIDDBDFacultad;
	-- Creamos base de datos 'Facultad'
CREATE DATABASE IIDDBDFacultad;
